 ...
 */
contract PositionWrapper is OwnableUpgradeable, ERC20Upgradeable, UUPSUpgradeable {
    ...
    function init(
        ...
        if (_positionManager == address(0) || _token0 == address(0) || _token1 == address(0)) {
    ...
    function setIntitialParameters(uint24 _fee, int24 _tickLower, int24 _tickUpper) external onlyOwner {
        initialFee = _fee;
     ...
     */
    // @audit @param newImplementation is not used anywhere
